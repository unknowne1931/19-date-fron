...
const Monitor = () => {
    ...
    useEffect(()=>{
        if(token){
            fetch("https://16.171.129.175/questionnns/datata/jdsjkds/fdsfdsnbc/f/f/f/s/sdf/f/b//dg//sd/g/sdg/ds/g/dsg/ds/g/sdg/ds/gsd/g/dsg/ds/gd/get")
            .then(res => res.json())
            .then(data => setDat(data));

            fetch("https://16.171.129.175/valid/id/leng/data/Length")
            .then(res => res.json())
            .then(data => setLen(data));

            fetch(`https://16.171.129.175/upi/module/importing/for/delete/fetch?key=${key}`)
            .then(res => res.json())
            ...
            fetch(`https://16.170.219.193/questionnns/datata/jdsjkds/fdsfdsnbc/paid/module?key=${key}`)
            .then(res => res.json())
            .then(data => setTot(data));

            fetch(`https://16.171.129.175/valid/id/leng/data/Length/child/new?key=${key}`)
            .then(res => res.json())
            .then(data => setLen2(data));

            fetch(`https://16.171.129.175/questionnns/datata/jdsjkds/fdsfdsnbc/paid/module/new/child?key=${key}`)
            .then(res => res.json())
            .then(data => setAlpaid(data));

            fetch(`https://16.171.129.175/questionnns/datata/jdsjkds/fdsfdsnbc/paid/module/new/child/all?key=${key}`)
            .then(res => res.json())
            .then(data => setAllpl(data))

            fetch(`https://16.171.129.175/valid/id/leng/data/Length/child/new/all?key=${key}`)
            .then(res => res.json())
            .then(data => setAlllen4(data));

            fetch(`https://13.51.85.151/valid/id/leng/data/Length/child/new/all/live?key=${key}`)
            .then(res => res.json())
            .then(data => setLive(data));

            const Key1 = "sjhdhg7dshkudfshg"
            fetch(`https://13.51.85.151/q/amount/data/all?key=${Key1}`)
            .then(res => res.json())
            .then(data => setAnmt(data));

            fetch(`https://16.170.242.41/user/module/importing/for/delete/fetch/verify/data?key=${key}`)
            .then(res => res.json())
            .then(data =>setVerifydat(data))

            fetch(`https://16.170.219.193/valid/id/leng/data/Length/child/new/all/verify/len?key=${key}`)
            .then(res => res.json())
    ...
    const Amontpost = (e) =>{
        e.preventDefault();
        axios.post("https://16.171.129.175/amount/data/post",{Amount, code})
        .then(res =>{
                ...
                {email &&
                    <div>
                        ...
                        <div className='roll-01'>
                            {data.map((user,i) =>{
                                const Delt = () =>{
                                    axios.delete(`https://16.171.129.175/delete/data/api/dont/know/ada/up/account/modeis/i/${user._id}?ip=${user.ip}&name=${user.name}&upi=${user.upi}`)
                                    .then(res =>{
                                        if(res.data.Status === "OK"){
                                            window.location.reload();
                                        }else{
                        ...
                        <div className='Monitor-imp-01'>
                            <div className='Monitor-imp-01-div-01'>
                                ...
                                <div className='roll-02'>
                                    ...
                                    {upi.map((user,i) =>{
                                        const Del1 = () =>{
                                            axios.delete(`https://16.171.129.175/delete/data/api/dont/know/ada/upi/${user._id}`)
                                            .then(res =>{
                                                if(res.data.Status === "OK"){
                                                    window.location.reload();
                                                }else{
                            ...
                            <div className='Monitor-imp-01-div-01'>
                                ...
                                {user.map((user,i) =>{
                                    const Del2 = () =>{
                                        axios.delete(`https://16.171.129.175/delete/data/api/dont/know/ada/upi/one/exts/${user._id}`)
                                        .then(res =>{
                                            if(res.data.Status === "OK"){
                                                window.location.reload();
                                            }else{
                            ...
                            <div className='Monitor-imp-01-div-01'>
                                ...
                                <div className='roll-02'>
                                    ...
                                    {verifydat.map((user,i) =>{
                                        ...
                                        const Del4 = () =>{
                                            axios.delete(`https://16.171.129.175/delete/data/api/dont/know/${user._id}`)
                                            .then(res =>{
                                                if(res.data.Status === "OK"){
                                                    window.location.reload();
                                                }else{
